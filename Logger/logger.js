 ...
 * 日志输出类
 */
export default class Logger extends BaseLog {
    /**
    ...
    constructor(props) {
        ...
        const userConfig = Logger.config;
        const instanceConfig = typeof props === 'string' ? { moduleName: props } : props;
        const options = Object.assign({}, defaultConfig, userConfig, instanceConfig);
        super(options);
